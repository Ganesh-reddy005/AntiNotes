...
class Profile(Document):
    ...
    # === LILLY AI COMPANION ===
    onboarding_summary: Optional[str] = None        # Lilly's wrap-up message from the interview
    lilly_last_nudge: Optional[str] = None           # Last nudge message shown on dashboard
    lilly_recommendation_title: Optional[str] = None # Last custom title generated by Lilly
    lilly_nudge_date: Optional[datetime] = None      # When the last nudge was generated
    lilly_recommended_tags: List[str] = Field(default_factory=list) # Dynamic tags generated by Lilly's nudge
